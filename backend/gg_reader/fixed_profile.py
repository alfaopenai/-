...
CLUBGG_COMPACT_8MAX = FixedGgProfile(
    ...
    seats=(
        FixedSeatProfile(
            index=0,
            label="top",
            name=(0.445, 0.212, 0.125, 0.035),
            stack=(0.445, 0.247, 0.130, 0.042),
            bet=(0.465, 0.285, 0.080, 0.065),
            cards=((0.448, 0.095, 0.052, 0.120), (0.498, 0.095, 0.052, 0.120)),
        ...
        FixedSeatProfile(
            index=1,
            label="upper-right",
            name=(0.770, 0.292, 0.130, 0.038),
            stack=(0.780, 0.327, 0.125, 0.045),
        ...
        FixedSeatProfile(
            index=3,
            label="bottom-right",
            name=(0.735, 0.785, 0.140, 0.040),
            stack=(0.735, 0.822, 0.140, 0.050),
            bet=(0.665, 0.610, 0.100, 0.070),
            cards=((0.735, 0.675, 0.055, 0.115), (0.790, 0.675, 0.055, 0.115)),
            active=(0.720, 0.665, 0.165, 0.215),
        ...
        FixedSeatProfile(
            index=5,
            label="bottom-left",
            name=(0.160, 0.785, 0.180, 0.040),
            stack=(0.168, 0.823, 0.160, 0.052),
            bet=(0.240, 0.610, 0.100, 0.070),
            cards=((0.160, 0.675, 0.057, 0.115), (0.215, 0.675, 0.057, 0.115)),
            active=(0.150, 0.665, 0.190, 0.210),
            dealer=(0.245, 0.705, 0.060, 0.070),
        ...
        FixedSeatProfile(
            index=7,
            label="upper-left",
            name=(0.118, 0.292, 0.150, 0.038),
            stack=(0.120, 0.327, 0.145, 0.045),
            bet=(0.225, 0.350, 0.075, 0.080),
